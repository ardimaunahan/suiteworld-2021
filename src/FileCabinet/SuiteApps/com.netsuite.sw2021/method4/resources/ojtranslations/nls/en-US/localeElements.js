        ...
        'es-US': {
            ...
            dates: {
                ...
                fields: {
                    ...
                    wed: {'relative-type--1': 'el miércoles pasado'},
                    thu: {'relative-type--1': 'el jueves pasado'},
                    fri: {'relative-type--1': 'el viernes pasado'},
                    sat: {'relative-type--1': 'el sábado pasado'},
                    hour: {
                        'relativeTime-type-future': {
            ...
            numbers: {
                ...
                currencies: {
                    AUD: {displayName: 'dólar australiano', symbol: 'AUD'},
                    BRL: {displayName: 'real brasileño', symbol: 'BRL'},
                    CAD: {displayName: 'dólar canadiense', symbol: 'CAD'},
                    ...
                    HKD: {displayName: 'dólar hongkonés', symbol: 'HKD'},
                    HUF: {displayName: 'forinto húngaro', symbol: 'HUF'},
                    ...
                    SAR: {displayName: 'rial saudí', symbol: 'SAR'},
                    SEK: {displayName: 'corona sueca', symbol: 'SEK'},
                    THB: {displayName: 'bat', symbol: 'THB'},
                    TRY: {displayName: 'lira turca', symbol: 'TRY'},
                    TWD: {displayName: 'nuevo dólar taiwanés', symbol: 'TWD'},
                    USD: {displayName: 'dólar estadounidense', symbol: '$'},
